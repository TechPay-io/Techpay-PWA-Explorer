                    ...
                    <div class="balance center-v">
                        <h3 class="h1">
                            <span v-show="cAccount">
                                <f-t-m-token-value :value="cAccount ? cAccount.totalValue : 1" convert no-currency /> <span class="tpc">TPC</span>
                            </span>
                        </h3>
                    ...
                    <div class="balance center-v">
                        <h3 class="h1">
                            <span v-show="'available' in cAssets">
                                <f-t-m-token-value :value="cAssets.available" convert no-currency /> <span class="tpc">TPC</span>
                            </span>
                        </h3>
