                ...
                <div class="row no-collapse">
                    ...
                    <div class="col">
                        <div v-show="'stake' in cStaker">
                            {{ formatNumberByLocale(numToFixed(WEIToTPC(cStaker.stake), 0)) }} TPC
                        </div>
                    </div>
                </div>
                ...
                <div class="row no-collapse">
                    ...
                    <div class="col">
                        <div v-show="'delegatedMe' in cStaker">
                            {{ formatNumberByLocale(numToFixed(WEIToTPC(cStaker.delegatedMe), 0)) }} TPC
                        </div>
                    </div>
                </div>
                ...
                <div class="row no-collapse">
                    ...
                    <div class="col">
                        <div v-show="'totalStake' in cStaker">
                            {{ formatNumberByLocale(numToFixed(WEIToTPC(cStaker.totalStake), 0)) }} TPC
                        </div>
                    </div>
                </div>
