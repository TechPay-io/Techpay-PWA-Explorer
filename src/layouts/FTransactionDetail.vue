            ...
            <template v-if="!dTransactionByHashError">
                ...
                <template v-else>
                    ...
                    <div class="row no-collapse">
                        ...
                        <div class="col"><div class="break-word" v-show="cTransaction">{{  WEIToTPC(cTransaction.value) }} TPC</div></div>
                    </div>
                    <!--
                                <div class="row no-collapse">
                                    <div class="col-4 f-row-label">{{ $t('view_transaction_detail.fee') }}</div>
                                    <div class="col"><div class="break-word" v-show="cTransaction">{{  WEIToTPC(cTransaction.fee) }} TPC</div></div>
                                </div>
                    -->
                    <div class="row no-collapse">
                    ...
                    <div class="row no-collapse">
                        ...
                        <div class="col"><div class="break-word" v-show="cTransaction">{{  cTransactionFee }} TPC</div></div>
                    </div>
                    <div class="row no-collapse">
    ...
    export default {
        ...
        computed: {
            ...
            cTransactionFee() {
                ...
                if (transaction) {
                    return WEIToTPC(this.formatHexToInt(transaction.gasPrice) * this.formatHexToInt(transaction.gasUsed));
                }
