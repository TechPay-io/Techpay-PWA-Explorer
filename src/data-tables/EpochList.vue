    ...
    data() {
        return {
            ...
            dColumns: [
                ...
                /*{
                    name: 'baseReward',
                    label: this.$t('epoch.total_base_reward') + ' (TPC)',
                    itemProp: 'epoch.totalBaseRewardWeight',
                    formatter: (_value) => formatNumberByLocale(WEIToTPC(_value), 1, 2),
                    cssClass: 'align-end',
                },*/
                {
                    name: 'fee',
                    label: this.$t('epoch.total_fee') + ' (TPC)',
                ...
                /*{
                    name: 'txReward',
                    label: this.$t('epoch.total_tx_reward') + ' (TPC)',
